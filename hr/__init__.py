...
def main(global_config, **settings):
    ...
    config = Configurator(settings=settings,root_factory='hr.models.SecurityFactory.SecurityFactory',session_factory = my_session_factory)
    ...
    config.add_route('skillset_entry_add','/skillset_entry/{person_id}/{review_id}/add/{skillset_id}/{interval}/{rating}')

...
class GhostClientUtilization(object):
    ...
    def calculateUtilization(self):
        ...
        for user_allocation in self.ghost_client.team:
            ...
            user_utilization = UserUtilization(user_allocation.user.name,user_allocation.user.role.name,user_allocation.user_id,self.year,user_allocation.start_date,user_allocation.end_date,user_allocation.utilization)
        ...
        for ghost_allocation in self.ghost_client.ghost_team:
            ...
            ghost_utilization = UserUtilization(ghost_allocation.ghost_user.role.name,ghost_allocation.ghost_user.role.name,ghost_allocation.ghost_user_id,self.year,ghost_allocation.start_date,ghost_allocation.end_date,ghost_allocation.utilization)

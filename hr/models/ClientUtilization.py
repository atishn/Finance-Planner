...
class ClientUtilization(object):
    ...
    def calculateUtilization(self):
        ...
        for user_allocation in self.client.team:
            ...
            user_utilization = UserUtilization(user_allocation.user.name,user_allocation.user.role,user_allocation.user_id,self.year,user_allocation.start_date,user_allocation.end_date,user_allocation.utilization)
        ...
        for ghost_allocation in self.client.ghost_team:
            ...
            ghost_utilization = UserUtilization(ghost_allocation.ghost_user.role,ghost_allocation.ghost_user.role.name,ghost_allocation.ghost_user_id,self.year,ghost_allocation.start_date,ghost_allocation.end_date,ghost_allocation.utilization)
        ...
        for freelancer in self.client.freelancers:
            ...
            freelancer_utilization = UserUtilization(freelancer.name,freelancer.role,freelancer.id,self.year,freelancer.start_date,freelancer.end_date,freelancer.utilization)

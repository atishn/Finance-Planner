...
class Permissions(Base):
    ...
    def __init__(self, is_administrator=None, can_view_salaries=None, can_edit_salaries=None, can_view_all_offices=None,
                 can_edit_all_offices=None, can_view_all_departments=None, can_edit_all_departments=None):

...
def main(argv=sys.argv):
    ...
    with transaction.manager:
        ...
        corp = Office("Corporate",huge)
        ny = Office("New York",huge)
        la = Office("Los Angeles",huge)
        sf = Office("San Francisco",huge)
        dc = Office("Washington DC",huge)
        pd = Office("Portland",huge)
        at = Office("Atlanta",huge)
        ri = Office("Rio de Janiero",huge)
        ld = Office("London",huge)
        bz = Office("Brazilia",huge)
        bt = Office("Boutique",huge)
        ...
        meghan = User(huge,"Meghan Francis Henderson","mhenderson@hugeinc.com",ny,vppm,150000,datetime.date(2013, 1, 1))
        ...
        gp = GhostProject("development",lexus,None,1200000,90,datetime.date(2013,8,1),datetime.date(2013,12,31))

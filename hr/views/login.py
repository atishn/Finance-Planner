...
def login(request):
    ...
    if 'form.submitted' in request.params:
        ...
        if user is None:
            return dict(message = 'user not found',url = request.application_url + '/login',came_from = came_from,email=email)
        ...
        if user.is_valid_password(password):
            ...
            return dict(message = 'invalid password',url = request.application_url + '/login',came_from = came_from,email=email)

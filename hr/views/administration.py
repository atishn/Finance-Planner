...
@view_config(route_name='administration_company',request_method='GET',renderer='templates/administration_company.html')
def administration_company(request):
    ...
    try:
        ...
        return dict(logged_in = authenticated_userid(request),header = Header("administration"),account=account,user=user)
    except:
        return HTTPFound(request.application_url)
    
@view_config(route_name='administration_employees',request_method='GET',renderer='templates/administration_employees.html')
...
@view_config(route_name='administration_company_edit',request_method='GET',renderer='templates/administration_company_edit.html')
@view_config(route_name='administration_company_edit',request_method='POST',renderer='templates/administration_company_edit.html')
    ...
    try:
        ...
        if request.method=="POST":
            ...
            if acc is None or acc.id == account.id:
                DBSession.query(Account).filter_by(id=account_id).update({'name': name,'benefits_and_bonus':benefits_and_bonus})
                DBSession.flush()
...
@view_config(route_name='administration_password',request_method='GET',renderer='templates/administration_password.html')
@view_config(route_name='administration_password',request_method='POST',renderer='templates/administration_password.html')
...
@view_config(route_name='administration_revenue',request_method='GET',renderer='templates/administration_revenue.html')
@view_config(route_name='administration_revenue',request_method='POST',renderer='templates/administration_revenue.html')
def administration_revenue(request):
    ...
    try:
        ...
        if request.method=="POST":
            ...
            quarter_end_date = datetime.date(long(quarter_end_date_dateparts[2]),long(quarter_end_date_dateparts[0]),long(quarter_end_date_dateparts[1]))
            ...
            for project in account.projects:
                ...
                actual_revenue = DBSession.query(ActualRevenue).filter_by(project_id = project.id).filter_by(quarter_end_date = quarter_end_date).first()
...
@view_config(route_name='administration_expenses_offices',request_method='GET',renderer='templates/administration_expenses_offices.html')
@view_config(route_name='administration_expenses_offices',request_method='POST',renderer='templates/administration_expenses_offices.html')
    ...
    try:
        ...
        if request.method=="POST":
            ...
            for office in account.offices:
                ...
                actual_expense = DBSession.query(ActualExpense).filter_by(office_id = office.id).filter_by(quarter_end_date = quarter_end_date).first()
...
@view_config(route_name='administration_expenses_clients',request_method='GET',renderer='templates/administration_expenses_clients.html')
@view_config(route_name='administration_expenses_clients',request_method='POST',renderer='templates/administration_expenses_clients.html')
    ...
    try:
        ...
        if request.method=="POST":
            ...
            for client in account.clients:
                ...
                actual_expense = DBSession.query(ActualExpense).filter_by(client_id = client.id).filter_by(quarter_end_date = quarter_end_date).first()

...
def freelancer_add(request):
    ...
    try:
        ...
        return dict(logged_in = authenticated_userid(request),header=Header('financials'),clients=clients,offices=offices,roles=roles,user=user,account=account)
    except:
        return HTTPFound(request.application_url)
...
def freelancer_edit(request):
    ...
    try:
        ...
        return dict(logged_in = authenticated_userid(request),header=Header('financials'),clients=clients,offices=offices,roles=roles,freelancer=freelancer,user=user,account=account)
    except:
        print("*************")
        traceback.print_exc()
        return HTTPFound(request.application_url)
...
def freelancer_delete(request):
    ...
    try:
        ...
        return HTTPFound(request.application_url + "/client/" + str(source_id) + "/utilization/" + str(datetime.datetime.now().year))
